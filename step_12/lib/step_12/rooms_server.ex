defmodule Step_12.RoomServer do
  use GenServer
  ...
  defp add_room_to_state(state, room_name) do
    ...
    Map.put_new(state, room_name |> String.downcase, [connections: [], description: nil, password: nil])
  end

  defp update_room_description(state, room_name, room_description) do
    Map.update(state, room_name |> String.downcase, [connections: [], description: nil, password: nil], fn(room_data) -> 
