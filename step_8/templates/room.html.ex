        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="input-group input-group-lg">
              <input ng-model="chatMsg" class="form-control" type="text" />
              <span class="input-group-btn">
                <button class="btn btn-default" ng-click="sendWSMsg(chatMsg)">Send Msg</button>
              </span>
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      app.controller("MainCtrl", function($scope, $http, $q, RoomData) {
        ...
        var createWSConnection = function() {
          var wsHost = "ws://" + window.location.host + "/websocket/" + $scope.roomName;
        ...
        var closeWSConnection = function() {
          if (websocket.readyState == websocket.OPEN) {
            websocket.close();
            console.log("Connection closed");
          } else {
            console.log("There is no websocket connection to close");
          }
        };
        ...
        var onMessage = function(msg) {
          $scope.$apply(function() {
            $scope.chatMessages.push(msg.data);
          });
        ...
        $scope.sendWSMsg = function(message) {
          $scope.chatMsg = "";
